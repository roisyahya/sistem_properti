...
class Operasional_marketing extends CI_Controller {
	...
	public function index()
	{
		...
		$data=array(
			...
			'no_trans'=>$this->M_operasional_all->get_no_trans_marketing(),
			
			);

		$data['operasional_marketing'] = $this->M_operasional_all->get_operasional();

		$this->load->view('bendahara/template/header');
		$this->load->view('bendahara/template/sidebar');
		$this->load->view('bendahara/operasional_marketing', $data);
		$this->load->view('bendahara/template/footer_marketing');
	...
	public function ajax_list()
	{
		...
		$list = $this->M_operasional_all->get_datatables_marketing();
		$data = array();
		$no = $_POST['start'];
