...
class Operasional_proyek extends CI_Controller {
	...
	public function index()
	{
		...
		$data=array(
			...
			'no_trans'=>$this->M_operasional_all->get_no_trans_proyek(),
			
			);

		$data['operasional_proyek'] = $this->M_operasional_all->get_operasional();

		$this->load->view('bendahara/template/header');
		$this->load->view('bendahara/template/sidebar');
		$this->load->view('bendahara/operasional_proyek', $data);
		$this->load->view('bendahara/template/footer_proyek');
	...
	public function ajax_list()
	{
		...
		$list = $this->M_operasional_all->get_datatables_proyek();
		$data = array();
		$no = $_POST['start'];
