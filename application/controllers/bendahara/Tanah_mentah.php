...
class Tanah_mentah extends CI_Controller {
	...
	public function index()
	{
		...
		$data=array(
			...
			'no_trans'=>$this->M_operasional_all->get_no_trans_tanah_mentah(),
			
			);

		$data['tanah_mentah'] = $this->M_operasional_all->get_operasional();

		$this->load->view('bendahara/template/header');
		$this->load->view('bendahara/template/sidebar');
		$this->load->view('bendahara/tanah_mentah', $data);
		$this->load->view('bendahara/template/footer_tanah_mentah');
	...
	public function ajax_list()
	{
		...
		$list = $this->M_operasional_all->get_datatables_mentah();
		$data = array();
		$no = $_POST['start'];
	...
	public function ajax_add()
	{
		...
		$data = array(
				'jenis_operasional' => 'tanah_mentah',
