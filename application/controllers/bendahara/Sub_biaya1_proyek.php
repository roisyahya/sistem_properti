...
class Sub_biaya1_proyek extends CI_Controller {
	...
	public function add_sub_biaya1_proyek() {
	...
	public function edit_sub_biaya1_proyek() {
	...
	public function delete_sub_biaya1_proyek($id) {
