...
class Sub_biaya1_marketing extends CI_Controller {
	...
	public function add_sub_biaya1_marketing() {
	...
	public function edit_sub_biaya1_marketing() {
	...
	public function delete_sub_biaya1_marketing($id) {
