...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Operasional marketing  PT ENGGANG PROPERTINDO SAKTI
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Data Operasional marketing</a></li>
      </ol>
    </section>
      ...
      <div class="modal-body form">
        ...
        <form action="#" id="form_edit" class="form-horizontal">
          <table class="table table-hover">
            ...
            <?php
                  $no = 1;
                  foreach ($operasional_marketing as $row) { } ?>
            ...
            <td>:</td>
            <td colspan=2>
               <input type="text"  class="form-control" id="" value="<?php echo date('d/m/Y', strtotime($row->tgl_trans));?>" readonly>
