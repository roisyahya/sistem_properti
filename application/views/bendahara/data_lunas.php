...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Pembelian Lunas PT ENGGANG PROPERTINDO SAKTI
...
<div class="box">
  ...
  <a href="<?php echo site_url('bendahara/data_lunas/detail_lunas/'.$row->id_pembayaran);?>"><button class="btn btn-info" ><i class="glyphicon glyphicon-info-sign">Detail</i></button></a>
