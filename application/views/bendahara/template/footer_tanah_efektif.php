...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/bendahara/tanah_efektif/ajax_list/')?>",
            "type": "POST"
        },
...
function edit_operasional(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/bendahara/tanah_mentah/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/bendahara/tanah_mentah/ajax_add/')?>";
    } else {
