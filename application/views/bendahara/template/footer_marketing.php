...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/bendahara/operasional_marketing/ajax_list/')?>",
            "type": "POST"
        },
...
function tambah_operasional()
{
    ...
    $('.modal-title').text('Input Data Operasional marketing'); // Set Title to Bootstrap modal title
...
function edit_operasional(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/bendahara/operasional_marketing/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Info Detail Operasional marketing'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/bendahara/operasional_marketing/ajax_add/')?>";
    } else {
