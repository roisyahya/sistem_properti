...
$(document).ready(function() {
    ...
    table = $('#ex').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/bendahara/operasional_kantor/ajax_list/')?>",
            "type": "POST"
        },
...
function edit_operasional(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/bendahara/operasional_kantor/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/bendahara/operasional_kantor/ajax_add/')?>";
    } else {
