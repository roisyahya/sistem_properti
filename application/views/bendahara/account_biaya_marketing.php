...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Account Biaya Marketing PT ENGGANG PROPERTINDO SAKTI
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Account Biaya marketing</a></li>
      </ol>
    </section>
...
<div class="box">
  ...
  <a href="<?php echo site_url('bendahara/account_biaya_marketing/sub_biaya1_marketing/'.$row->id_kel_biaya);?>"><button class="btn btn-info" ><i class="glyphicon glyphicon-plus-sign">SubBiaya1</i></button></a>
  ...
  $('.help-block').empty(); 
      ...
      function save() {
        ...
        if(save_method=='add') {
          url =  '<?php echo site_url('index.php/bendahara/account_biaya_marketing/add_account_biaya_marketing/'); ?>';
        } else {
          url =  '<?php echo site_url('index.php/bendahara/account_biaya_marketing/edit_account_biaya_marketing/'); ?>';
        }
  ...
  $('.help-block').empty(); 
        ...
        //load dari ajax
        $.ajax({
          url: "<?php echo site_url('index.php/bendahara/account_biaya_marketing/ajax_edit/'); ?>"+id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
      ...
      function delete_kode_account(id) {
        if (confirm('Are you sure delete data?')) {
          ...
          $.ajax({
            url: "<?php echo site_url('index.php/bendahara/account_biaya_marketing/delete_account_biaya_marketing/'); ?>"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
              location.reload();
