...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Account Biaya proyek PT ENGGANG PROPERTINDO SAKTI
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Account Biaya proyek</a></li>
      </ol>
    </section>
...
<div class="box">
  ...
  <a href="<?php echo site_url('bendahara/account_biaya_proyek/sub_biaya1_proyek/'.$row->id_kel_biaya);?>"><button class="btn btn-info" ><i class="glyphicon glyphicon-plus-sign">SubBiaya1</i></button></a>
  ...
  $('.help-block').empty(); 
      ...
      function save() {
        ...
        if(save_method=='add') {
          url =  '<?php echo site_url('index.php/bendahara/account_biaya_proyek/add_account_biaya_proyek/'); ?>';
        } else {
          url =  '<?php echo site_url('index.php/bendahara/account_biaya_proyek/edit_account_biaya_proyek/'); ?>';
        }
  ...
  $('.help-block').empty(); 
        ...
        //load dari ajax
        $.ajax({
          url: "<?php echo site_url('index.php/bendahara/account_biaya_proyek/ajax_edit/'); ?>"+id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
      ...
      function delete_kode_account(id) {
        if (confirm('Are you sure delete data?')) {
          ...
          $.ajax({
            url: "<?php echo site_url('index.php/bendahara/account_biaya_proyek/delete_account_biaya_proyek/'); ?>"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
              location.reload();
