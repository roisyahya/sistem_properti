...
<div class="box">
  ...
  <a href="<?php echo site_url('bendahara/account_biaya_marketing/sub_biaya2_marketing/'.$row->id_sub_biaya1);?>"><button class="btn btn-info" ><i class="glyphicon glyphicon-plus-sign">SubBiaya2</i></button></a>      
  ...
  $('.help-block').empty(); 
      ...
      function save() {
        ...
        if(save_method=='add') {
          url =  '<?php echo site_url('index.php/bendahara/sub_biaya1_marketing/add_sub_biaya1_marketing/'); ?>';
        } else {
          url =  '<?php echo site_url('index.php/bendahara/sub_biaya1_marketing/edit_sub_biaya1_marketing/'); ?>';
        }
  ...
  $('.help-block').empty(); 
        ...
        //load dari ajax
        $.ajax({
          url: "<?php echo site_url('index.php/bendahara/sub_biaya1_marketing/ajax_edit/'); ?>"+id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
      ...
      function delete_sub_biaya1(id) {
        if (confirm('Are you sure delete data?')) {
          ...
          $.ajax({
            url: "<?php echo site_url('index.php/bendahara/sub_biaya1_marketing/delete_sub_biaya1_marketing/'); ?>"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
              location.reload();
