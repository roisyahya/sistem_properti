...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        RAB Jumlah Unit PT ENGGANG PROPERTINDO SAKTI
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">RAB Jumlah Unit</a></li>
      </ol>
    </section>
...
<div class="box">
  ...
  <button class="btn btn-success" onclick="tambah_jumlah_unit()"><i class="glyphicon glyphicon-plus">Tambah</i></button>      
  <a href="<?php echo base_url('bendahara/jumlah_unit');?>"><button class="btn btn-success"><i class="glyphicon glyphicon-refresh">Refresh</i></button></a>
  <br>
  <br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <tr>
                                            ...
                                            <td><?php echo $row->persen_tanah; ?></td>
  ...
  <button class="btn btn-warning" onclick="edit_jumlah_unit(<?php echo $row->id_jumlah_unit; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
  <button class="btn btn-danger" onclick="delete_jumlah_unit(<?php echo $row->id_jumlah_unit; ?>)"><i class="glyphicon glyphicon-remove"></i></button>      
