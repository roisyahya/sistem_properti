...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        RAB Sarana PT ENGGANG PROPERTINDO SAKTI
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">RAB Sarana</a></li>
      </ol>
    </section>
...
<div class="box">
  ...
  <button class="btn btn-success" onclick="tambah_sarana()"><i class="glyphicon glyphicon-plus">Tambah</i></button>      
  <a href="<?php echo base_url('bendahara/sarana');?>"><button class="btn btn-success"><i class="glyphicon glyphicon-refresh">Refresh</i></button></a>
  <br>
  <br>
  ...
  <button class="btn btn-warning" onclick="edit_sarana(<?php echo $row->id_sarana; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
  <button class="btn btn-danger" onclick="delete_sarana(<?php echo $row->id_sarana; ?>)"><i class="glyphicon glyphicon-remove"></i></button>      
    ...
    ?>
      ...
      <th>
      <?php
      $total_semua = $this->db->query("SELECT sum(total) AS total_semua FROM rab_sarana")->row_array();
  ...
  $('.help-block').empty(); 
      ...
      function save() {
        ...
        if(save_method=='add') {
          url =  '<?php echo site_url('index.php/bendahara/sarana/add_sarana/'); ?>';
        } else {
          url =  '<?php echo site_url('index.php/bendahara/sarana/edit_sarana/'); ?>';
        }
  ...
  $('.help-block').empty(); 
        ...
        //load dari ajax
        $.ajax({
          url: "<?php echo site_url('index.php/bendahara/sarana/ajax_edit/'); ?>"+id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
      ...
      function delete_sarana(id) {
        if (confirm('Are you sure delete data?')) {

          $.ajax({
            url: "<?php echo site_url('index.php/bendahara/sarana/delete_sarana/'); ?>"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
              location.reload();
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form">
        <form action="#" id="form" class="form-horizontal">
          <input type="hidden" name="id_sarana" value="">
