<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Pembangunan Proyek Tanah PT ENGGANG PROPERTINDO SAKTI
...
<div class="box">
  ...
  <br>
   ...
   <a class="btn btn-info" href="<?php echo site_url('proyek/daftar_unit/detail_unit/'.$row->id_wilayah);?>"><i class="glyphicon glyphicon-info-sign"></i> Info</a>
