...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/proyek/gudang/ajax_list/')?>",
            "type": "POST"
        },
...
function edit_operasional(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/proyek/gudang/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/proyek/gudang/ajax_add/')?>";
    }
...
function save_status()
{
    ...
    if(save_method == 'update') {
        ...
        url = "<?php echo site_url('index.php/proyek/gudang/ajax_update/')?>";
    }
