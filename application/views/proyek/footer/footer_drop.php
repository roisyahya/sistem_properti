...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/proyek/drop_ditempat/ajax_list/')?>",
            "type": "POST"
        },
...
function tambah_operasional()
{
    ...
    $('.modal-title').text('Input Data Barang didrop di tempat'); // Set Title to Bootstrap modal title
...
function edit_operasional(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/proyek/drop_ditempat/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="id_drop"]').val(data.id_drop);          
            ...
            $('.modal-title').text('Info Barang didrop di tempat'); // Set title to Bootstrap modal title
...
function edit_status(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('.modal-title').text('Info Barang Drop ditampat'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/proyek/drop_ditempat/ajax_add/')?>";
    }
...
function save_status()
{
    ...
    if(save_method == 'update') {
        ...
        url = "<?php echo site_url('index.php/proyek/drop_ditempat/ajax_update/')?>";
    }
