...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Laporan Data Barang Masuk Proyek PT ENGGANG PROPERTINDO SAKTI
...
<div class="box">
  ...
  <hr><br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PETUNJUK PENGGUNAAN LAPORAN :<br><br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. Tentukan terlebih dahulu range tanggal yang akan dicetak.<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Kemudian klik tombol 'cari'.<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Untuk mencetak dalam bentuk pdf/excel, silahkan tentukan range tanggal terlebih dahulu kemudian klik tombol.<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4. Untuk mencetak data stok terbaru dalam bentuk pdf, dapat langsung menekan tombol stok sekarang tanpa harus menentukan range tanggal terlebih dahulu.<br>
  
  <hr>

    <form action="<?php echo base_url('proyek/laporan_stok/laporan_stok/');?>" id="form" class="form-horizontal" method="post">
    <div class="form-body">
            <div class="form-group">
              <label class="control-label col-md-1">Dari Tanggal</label>
              <div class="col-md-3">
                 <input type="text" name="tgl_awal" class="form-control pull-right" id="datepicker">

              </div>
            
         
            <div class="form-group">
              <label class="control-label col-md-1">Sampai Tanggal</label>
              <div class="col-md-3">
                 <input type="text" name="tgl_akhir" class="form-control pull-right" id="datepicker1">
              </div>
 ...
 <button class="btn btn-warning" name="submit" type"submit" value="Cari"><i class="glyphicon glyphicon-search"></i>Cari</button>
 <button class="btn btn-info" name="submit" type"submit" value="PDF"><i class="glyphicon glyphicon-save-file"></i>PDF</button>
 <button class="btn btn-danger" name="submit" type"submit" value="Excel"><i class="glyphicon glyphicon-remove"></i>Excel</button>
 <button class="btn btn-success" name="submit" type"submit" value="Sekarang"><i class="glyphicon glyphicon-save-file"></i>Stok Sekarang</button>
      ...
      <div class="modal-body form">
        ...
        <form action="#" id="form_edit_status" class="form-horizontal">
          <table class="table table-hover">
            ...
            <input type="hidden" name="id_barang_masuk" class="form-control">
