...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/marketing/on_process/ajax_list/')?>",
            "type": "POST"
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/marketing/on_process/ajax_add/')?>";
    }
...
function save_status()
{
    ...
    if(save_method == 'update') {
        ...
        url = "<?php echo site_url('index.php/marketing/on_process/ajax_update/')?>";
    }
